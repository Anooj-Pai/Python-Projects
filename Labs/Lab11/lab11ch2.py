...
class BallDraw(object):
    def __init__ (self, parent):
        self.ball_ = Ball(80, 200, 6, -3, 10, 'red') #r info
    ...
    def slower(self):
        self.wait_time *= 2
        self.ball_.ball_dx = -6
            
    def restart(self):
        self.isstopped = False
        self.ball_.reset() #reset
        self.animate()
    ...
    def draw_ball(self):
        ...
        self.canvas.create_oval(self.ball_.bounding_box(), fill=self.ball_.get_color()) # r
    ...
    def animate(self):
        ...
        while self.ball_.some_inside(self.maxx, self.maxy): # r
            # Move the ball
            self.draw_ball()
            self.ball_.check_and_reverse(self.maxx, self.maxy)
            self.ball_.move() #r
