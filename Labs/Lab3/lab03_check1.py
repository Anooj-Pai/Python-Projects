...
print("The point has moved from ({:d},{:d}) ".format(initial_x, initial_y),"to", str(next_x),",", next_y)

print("Total length traveled is {:.02f}".format(line_length(initial_x, initial_y, next_x, next_y)))
